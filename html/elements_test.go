...
func TestCaption(t *testing.T) {
	el := Caption(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestFigCaption(t *testing.T) {
	el := FigCaption(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestAddress(t *testing.T) {
	el := Address(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestArticle(t *testing.T) {
	el := Article(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestBlockQuote(t *testing.T) {
	el := BlockQuote(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestColGroup(t *testing.T) {
	el := ColGroup(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestDataElement(t *testing.T) {
	el := DataElement(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestDataList(t *testing.T) {
	el := DataList(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestDetails(t *testing.T) {
	el := Details(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestFieldSet(t *testing.T) {
	el := FieldSet(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestNoScript(t *testing.T) {
	el := NoScript(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestOptGroup(t *testing.T) {
	el := OptGroup(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestPicture(t *testing.T) {
	el := Picture(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestProgress(t *testing.T) {
	el := Progress(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestSection(t *testing.T) {
	el := Section(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestStyleElement(t *testing.T) {
	el := StyleElement(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestSummary(t *testing.T) {
	el := Summary(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestTemplate(t *testing.T) {
	el := Template(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestTextarea(t *testing.T) {
	el := Textarea(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
...
func TestTitleElement(t *testing.T) {
	el := TitleElement(Id(1), aitch.Text("foo"))
	require.Equal(t, aitch.ElementNode, el.Type())
